...
# Transform ground truth to match the estimated path
R_entry = ground_truth_pos.iloc[0]
rot: Rotation = Rotation.from_matrix([[R_entry.R00, R_entry.R01, R_entry.R02],
                                      [R_entry.R10, R_entry.R11, R_entry.R12],
                                      [R_entry.R20, R_entry.R21, R_entry.R22]])
